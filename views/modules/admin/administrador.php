    ...
    <div class="content h-100 d-flex flex-column bg-white w-100">
        ...
        <div class="menu h-100 p-3">
                <ul class="contenedor-menu w-90 h-100 text-center">
                    ...
                    <li>
                        <a href="./departamentos.php"><img class="icono" style="width: 50px; height: 50px;" src="https://cdn-icons.flaticon.com/png/512/3369/premium/3369137.png?token=exp=1646924659~hmac=32b67827016aa730ad648be17607bb4f"/><span>Gestionar De Unidades Responsables</span></a>
                    </li>
                    <li>
