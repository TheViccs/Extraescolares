...
<body>
    ...
    <div class="contenedor_principal_insercion">
        ...
        <!-- CABECERA -->
        <div class="cabecera">
            <h1 class="titulo">Agregar Alumno a Grupo</h1>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-alumno-label">Agregar Alumno</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-center">
                    <div class="w-100">
                        <h3>¿Seguro que quiere agregar al alumno a este grupo grupo?</h1>
                ...
                <div class="modal-footer d-flex justify-content-evenly">
                    ...
                    <button type="button" class="btn btn-success" onclick="agregar_alumno()">Inscribir</button>
                </div>
            </div>
        </div>
    </div>

    <script src="../../../js/coordinador_alumnos_agregar.js"></script>
