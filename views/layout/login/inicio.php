...
<body class="d-flex m-0 h-100 w-100">
    <div class="h-100 d-flex flex-column bg-white w-100" id="contenidoLogin">

        <!-- CONTENT -->
        <div class="d-flex flex-column h-100 w-100 justify-content-center align-items-center">
            <div class="d-flex flex-column align-items-center justify-content-around" style="width:25%;  background-color:white; border-radius:2%; border: 1px solid black; min-height: 60% !important; height:fit-content; max-height:fit-content; min-width:fit-content;">
                ...
                <button style="max-width:100%; max-height:25%; overflow:hidden" class="btn btn-success" onclick="login()">Iniciar Sesión</button>
            </div>
        </div>
    </div>
